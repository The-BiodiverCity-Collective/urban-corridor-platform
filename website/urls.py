...
urlpatterns = [
    ...
    path("gardens/<int:id>/carbon/", views.carbon_report, name="garden_carbon_report"),
    path("garden/<int:id>/score/", views.garden_score_overview, name="garden_score"),
    #path("garden/<int:id>/score/present/", views.garden_score, {"status": "PRESENT"}, name="garden_score_present"),
    #path("garden/<int:id>/score/future/", views.garden_score, {"status": "FUTURE"}, name="garden_score_future"),
    ...
    path("planner/<int:id>/plants/download/", views.planner_plants_download, name="planner_plants_download"),
    path("planner/<int:id>/plants/nurseries/", views.planner_nurseries, name="planner_nurseries"),
    path("planner/<int:id>/plants/nurseries/availability/", views.planner_plants_availability, name="planner_plants_availability"),
    ...
    path("controlpanel/cleanup/", views.controlpanel_cleanup, name="controlpanel_cleanup"),
]
