...
class SpeciesFeatures(models.Model):
    ...
    site = models.ManyToManyField(Site, blank=True, through="FeatureSiteScore")
...
class FileLog(models.Model):
    ...
    file = models.ForeignKey(Attachment, on_delete=models.CASCADE, related_name="log")
...
class InventoryUnit(models.Model):
    site = models.ForeignKey(Site, on_delete=models.CASCADE, null=True, blank=True, related_name="units")
